      ...
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        <Reveal>
          ...
          <h2 className="mt-2 text-2xl font-extrabold leading-relaxed text-brand-fg sm:text-3xl">
            دیابان: دستگاه تست قندخون خانگی، طراحی‌شده برای نیاز واقعی بیماران در ایران
          </h2>
          <p className="mt-5 text-base leading-8 text-muted-foreground sm:text-lg">
            در طراحی دیابان، دغدغه‌های واقعی بیماران دیابتی و توصیه پزشکان مبنای
            کار قرار گرفت: دسترسی همیشگی به نوار، دقت بالا، نمونه‌گیری کم‌درد و
            قیمت مقرون‌به‌صرفه. نتیجه، دستگاهی است که هم در کلینیک و هم در خانه
            قابل‌اعتماد است.
          </p>
