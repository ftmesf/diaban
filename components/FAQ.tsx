...
const FAQS = [
  {
    ...
    a: "دستگاه دیابان را می‌توانید از فروشگاه سیناکر، داروخانه‌ها، فروشگاه‌های تجهیزات پزشکی، دیجی‌کالا و سایر مراکز دارای تاییدیه سازمان غذا و دارو تهیه کنید.",
  },
  {
    q: "نوار تست دیابان همیشه در بازار هست؟",
    a: "بله؛ نوار تست دیابان به‌طور مستمر در داروخانه‌ها، فروشگاه‌های تجهیزات پزشکی و دیجی‌کالا توزیع می‌شود. «خیالت راحت، نوار تستش همیشه هست» همین تعهد را در قالب شعار دیابان بیان می‌کند.",
  },
  {
    q: "بعد از باز کردن بسته نوار، چقدر می‌تونم ازش استفاده کنم؟",
    a: "نوار تست دیابان حداکثر تا ۳ ماه پس از باز شدن درب پلمب قابل استفاده است.",
  },
  {
    q: "گارانتی دستگاه دیابان چقدره؟",
    a: "گارانتی دستگاه دیابان مادام‌العمر است.",
  },
  {
    q: "از صحت نتیجه دستگاه دیابان چطور مطمئن بشم؟",
    a: "دستگاه دیابان نیازی به کالیبراسیون دستی ندارد؛ کالیبراسیون به‌صورت خودکار و بدون دخالت کاربر انجام می‌شه. برای اطمینان بیشتر از صحت نتایج می‌تونید با خدمات پس از فروش دیابان تماس بگیرید: ۰۲۱-۹۱۰۰۲۰۰۲.",
  },
  {
